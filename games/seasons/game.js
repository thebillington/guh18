// Created by Billy Rebecchi for Games Plus Jam 2018
// Edited for the Great Uni Hack 2018 to be included as part of the 90s Steam project
...
function preload() {
    ...
    // Get the key image
    keyImg = loadImage(baseURL + "assets/key.png");

...
function setupAnimationReel() {
    ...
    // Get the backgrounds
    backgrounds = [];
    backgrounds.push(loadImage(baseURL + "assets/summer.png"));
    backgrounds.push(loadImage(baseURL + "assets/spring.png"));
    backgrounds.push(loadImage(baseURL + "assets/winter.png"));
    backgrounds.push(loadImage(baseURL + "assets/autumn.png"));
    
    // Get the instructions
    instructions = loadImage(baseURL + "assets/instructions.png");
    
    // Get the end game image
    endGameImg = loadImage(baseURL + "assets/winner.png");
    
    // Get all of the animations
    for (var i = 1; i < 6; i++) {
        // Push the frame
        leftWalk.push(loadImage(baseURL + "assets/playerAnimation/playerWalkLeft"+i+".png"));
        rightWalk.push(loadImage(baseURL + "assets/playerAnimation/playerWalkRight"+i+".png"));
        leftJump.push(loadImage(baseURL + "assets/playerAnimation/playerJumpLeft"+i+".png"));
        rightJump.push(loadImage(baseURL + "assets/playerAnimation/playerJumpRight"+i+".png"));
        still.push(loadImage(baseURL + "assets/playerAnimation/playerStill"+i+".png"));
        drown.push(loadImage(baseURL + "assets/playerAnimation/playerDrown"+i+".png"));
